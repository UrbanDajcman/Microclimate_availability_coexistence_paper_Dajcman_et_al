...
## MICROCLIMATE Trnovski gozd 45.95709 13.89497

# model rocks

#micro <- micro_global(loc = cbind(45.6127, 14.7346), timeinterval = 365, runmoist=1, snowmodel=1, soiltype=0, nyears = 1) # Dovzanova
...
save(micro, file='../Results/microNCEP/micro_ncep_Trnovski_aloIhor.RData')
load('micro_ncep_Trnovski_aloIhor.RData')
