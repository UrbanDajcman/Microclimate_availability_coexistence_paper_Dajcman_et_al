...
# micro_ncep Velike bele stene 45.6753 14.7082
...
save(micro, file='../Results/microNCEP/micro_ncep_VelikeBele_aloIhor.RData')
load('micro_ncep_VelikeBele_aloIhor.RData')
