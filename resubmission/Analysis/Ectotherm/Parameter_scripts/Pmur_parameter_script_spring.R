...
T_F_min <- 18.2     # minimum Tb at which activity occurs; from Osojnik et al (PMUR spring min_males)
T_F_max <- 32.8     # maximum Tb at which activity occurs; from Osojnik et al (PMUR spring max_males)
T_pref <- 26.9      # preferred Tb (will try and regulate to this); from Osojnik et al. (PMUR spring average_males)
...
getwd()
save.image(file='../../Data/DEB_Ectotherm_params_spring/PMuralis_pars_spring.RData')
