...
T_F_min <- 22.2     # minimum Tb at which activity occurs; from Osojnik et al (IHOR summer min_males)
T_F_max <- 33.2     # maximum Tb at which activity occurs; from Osojnik et al (IHOR summer max_males)
T_pref <- 30.4      # preferred Tb (will try and regulate to this)  from Osojnik et al (IHOR summer average_males)
CT_max <- 42.2      # critical thermal maximum (affects choice of retreat) Taken from Herrando-Perez et al.,  tolerance more variable
...
save.image(file='../../Data/DEB_Ectotherm_params/IHorvathi_pars.RData')
