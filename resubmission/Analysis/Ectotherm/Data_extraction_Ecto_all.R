...
for (s in 1:length(micro_nceps)){
  ...
  for(j in unique(results_all$Species)){
    ...
    save(ecto, file=paste0("../../Results/ecto_files/ecto_", j, "_", loc[s], ".Rda"))
...
save(results_all, file="../../Results/ECTOTHERM_results/results_all_ecto2.Rda")



library(xlsx)

write.xlsx(results_all, file="../../Results/ECTOTHERM_results/results_all_ecto2.xlsx", sheetName = "Ecto_rez")
