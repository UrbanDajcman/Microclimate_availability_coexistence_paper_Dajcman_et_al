...
## MICROCLIMATE Bilpa 45.512684, 14.962387
...
T_pref <- 32      # preferred Tb (will try and regulate to this)
...
library(R.matlab)
Pm.data <- readMat('C:/1_Urban/1_Doktorat/MODELIRANJE/DEB/DEB_models/debs_urtzi_check/DEBs_UD_Updated/Podarcis_muralis_UD/results_Podarcis_muralis.mat') # load the allstat file
...
L.b <- 0.442329 # had to take it manually from html
