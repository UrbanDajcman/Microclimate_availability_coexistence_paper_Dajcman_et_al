...
## MICROCLIMATE Kočevska reka 45.58196 14.79089
...
save(micro, file='../Results/microNCEP/micro_ncep_KocevskaReka_aloPmur.RData')
load('micro_ncep_KocevskaReka_aloPmur.RData')
