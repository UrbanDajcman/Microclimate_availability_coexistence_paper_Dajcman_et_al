...
## MICROCLIMATE Fridrihštajn 45.611355 14.860426
...
save(micro, file='../Results/microNCEP/micro_ncep_Fridrihstajn_aloPmur.RData')

load('micro_ncep_Fridrihstajn_aloPmur.RData')
