...
## MICROCLIMATE Planinska jama 45.8216 14.2471
...
save(micro, file='../Results/microNCEP/micro_ncep_PlaninskaJ_aloIhor.RData')
load('micro_ncep_PlaninskaJ_aloIhor.RData')
