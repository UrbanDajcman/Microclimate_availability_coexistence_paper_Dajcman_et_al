...
T_F_min <- 26     # minimum Tb at which activity occurs
T_F_max <- 37     # maximum Tb at which activity occurs
T_pref <- 29      # preferred Tb (will try and regulate to this)  TAKEN FROM TABLE OSOJNIK
